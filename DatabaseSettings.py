...
class DatabaseSettings():
    def __init__(self, kind='none'):
        ...
        self.unit_factors = {'elapsed time': time_factors,
        ...
        self.column_options['category1'] = ['sport', 'activity', 'gear', 'weekday',
                                            ...
                                            'weekday name',
                                            'week', 'month', 'year',
                                            'year week', 'year month', 'year month day',
                                            'category']
        ...
        self.column_options['quantity'] = ['total distance', 'total elapsed time',
                                           'avg speed', 'avg heart rate',
                                           'Amount', 'Balance',
                                           'delay']

        self.column_default['legend_variable'] = None
        self.column_options['legend_variable'] = ['sport', 'activity', 'gear', 'file name',
                                                  'weekday name',
        ...
        self.numeric_options['scatter_x'] = ['start daytime local']
    ...
    def set_settings_gps(self):
        ...
        self.database_path = os.path.abspath(os.path.join('data', 'Ana', 'tests', 'running'))
        # self.records_path = os.path.abspath(os.path.join('data', 'Ana', 'csv'))
        self.records_path = os.path.abspath(os.path.join('data', 'Ana', 'tests', 'running'))
        ...
        self.column_default['quantity'] = 'total distance'
        self.column_default['legend_variable'] = 'sport'

        self.numeric_default['scatter_x'] = 'avg speed'
        self.numeric_default['scatter_y'] = 'avg heart rate'
        self.numeric_default['histogram_x'] = 'avg speed'

        self.TracesTab = True
        self.trace_default['top_x'] = 'elapsed time'
        self.trace_default['top_y'] = 'speed'
        self.trace_default['bottom_x'] = 'position long'
        self.trace_default['bottom_y'] = 'position lat'
    ...
    def set_settings_expenses(self):
        ...
        self.column_default['category1'] = 'year month'
    ...
    def set_settings_late(self):
        ...
        self.numeric_default['scatter_x'] = 'meeting time'
