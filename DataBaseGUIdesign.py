...
class Ui_DataBaseGUI(object):
    def setupUi(self, DataBaseGUI):
        ...
        self.gridLayout_7.addWidget(self.StartLocationListWidget, 1, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.EndLocationListWidget, 1, 2, 1, 1)
        ...
        self.XComboBox1_2 = QtGui.QComboBox(self.layoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.XComboBox1_2.sizePolicy().hasHeightForWidth())
        self.XComboBox1_2.setSizePolicy(sizePolicy)
        self.XComboBox1_2.setObjectName(_fromUtf8("XComboBox1_2"))
        self.gridLayout_6.addWidget(self.XComboBox1_2, 2, 2, 1, 1)
        ...
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.Tab4)
        ...
        self.horizontalLayout_2.addWidget(self.Table2Widget)
    ...
    def retranslateUi(self, DataBaseGUI):
        ...
        self.RefreshPlot2PushButton.setText(_translate("DataBaseGUI", "Refresh Plot 2 and Table 2", None))
